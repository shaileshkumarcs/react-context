...
const Login = (props) => {
  ...
  const [emailState, dispachEmail] = useReducer(emailReducer, {value: '', isValid: false});
  const [passwordState, dispachPassword] = useReducer(passwordReducer, {value: '', isValid: false});
